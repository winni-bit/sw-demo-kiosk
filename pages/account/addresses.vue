          ...
          <div class="bg-neutral-900 rounded-2xl p-6">
            ...
            <div v-if="loading" class="grid md:grid-cols-2 gap-6">
              <div v-for="i in 2" :key="i" class="animate-pulse">
                <div class="h-48 bg-neutral-800 rounded-xl" />
              </div>
            </div>
            ...
            <div v-else-if="!hasAnyAddress" class="text-center py-12">
              ...
              <h3 class="text-xl font-semibold text-white mb-2">{{ t.noAddresses }}</h3>
              <p class="text-neutral-400">{{ t.noAddressesDescription }}</p>
            </div>
            ...
            <div v-else class="space-y-6">
              ...
              <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="p-5 bg-neutral-800 rounded-xl">
                  <div class="flex items-center gap-2 mb-4">
                    ...
                    <h2 class="text-lg font-semibold text-white">{{ t.billingAddress }}</h2>
                  </div>
                  ...
                  <div v-if="defaultBillingAddress" class="space-y-1">
                    ...
                    <p v-if="defaultBillingAddress.company" class="text-neutral-400">
                      {{ defaultBillingAddress.company }}
                    </p>
                    <p class="text-neutral-400">{{ defaultBillingAddress.street }}</p>
                    <p class="text-neutral-400">
                      {{ defaultBillingAddress.zipcode }} {{ defaultBillingAddress.city }}
                    </p>
                    <p v-if="defaultBillingAddress.countryState?.name" class="text-neutral-400">
                      {{ defaultBillingAddress.countryState.name }}
                    </p>
                    <p class="text-neutral-400">
                      {{ defaultBillingAddress.country?.name || '' }}
                    </p>
                    <p v-if="defaultBillingAddress.phoneNumber" class="text-neutral-400 mt-2">
                      <span class="text-neutral-500">{{ t.phone }}:</span> {{ defaultBillingAddress.phoneNumber }}
                    </p>
                  </div>
                ...
                <div class="p-5 bg-neutral-800 rounded-xl">
                  <div class="flex items-center gap-2 mb-4">
                    ...
                    <h2 class="text-lg font-semibold text-white">{{ t.shippingAddress }}</h2>
                  </div>
                  ...
                  <div v-if="defaultShippingAddress" class="space-y-1">
                    ...
                    <p v-if="defaultShippingAddress.company" class="text-neutral-400">
                      {{ defaultShippingAddress.company }}
                    </p>
                    <p class="text-neutral-400">{{ defaultShippingAddress.street }}</p>
                    <p class="text-neutral-400">
                      {{ defaultShippingAddress.zipcode }} {{ defaultShippingAddress.city }}
                    </p>
                    <p v-if="defaultShippingAddress.countryState?.name" class="text-neutral-400">
                      {{ defaultShippingAddress.countryState.name }}
                    </p>
                    <p class="text-neutral-400">
                      {{ defaultShippingAddress.country?.name || '' }}
                    </p>
                    <p v-if="defaultShippingAddress.phoneNumber" class="text-neutral-400 mt-2">
                      <span class="text-neutral-500">{{ t.phone }}:</span> {{ defaultShippingAddress.phoneNumber }}
                    </p>
                  </div>
                  <p v-else class="text-neutral-500">{{ t.noAddress }}</p>
                </div>
              ...
              <div v-if="additionalAddresses.length > 0" class="mt-8">
                <h2 class="text-lg font-semibold text-white mb-4">{{ t.additionalAddresses }}</h2>
                
                <div class="grid md:grid-cols-2 gap-4">
                  <div 
                    v-for="address in additionalAddresses" 
                    :key="address.id"
                    class="p-4 bg-neutral-800 rounded-xl"
                  >
                    <div class="space-y-1">
                      <p class="font-medium text-white">
                      ...
                      <p class="text-neutral-400">{{ address.street }}</p>
                      <p class="text-neutral-400">
                        {{ address.zipcode }} {{ address.city }}
                      </p>
                      <p v-if="address.countryState?.name" class="text-neutral-400">
            ...
            <!-- Info Message -->
            <div class="mt-6 p-4 bg-neutral-800/50 rounded-xl">
